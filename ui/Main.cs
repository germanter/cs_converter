...
namespace convix
{
    public class MainWindow : Window
    {
        ...
        private readonly double TasklistTextFontSize = 14.0; // Reduced to fit screen better!
        ...
        // Dedicated UI component injected into main layout
        ...
        private void BuildUI()
        {
            ...
            // Hook up the new TaskListUI component completely cleanly!
        ...
        private async void BlinkTimer_Tick(object? sender, EventArgs e)
        {
            ...
            { 
                // BUGFIX: Silent exception handling prevents async void lifecycle/ObjectDisposed process crashes 
            }
        }
