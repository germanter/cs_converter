...
// namespace convix
// {
//     public class Image2PdfUI : Grid, ICtgTool
//     {
...
//         // Implementations required by the global mounting frame
//         public Control SettingsControl => this;
//         public bool IsRotationEnabled => true;
//         public string DefaultFileName => "document";

//         public Image2PdfUI(SolidColorBrush bg, SolidColorBrush text, FontFamily font)
//         {
//             this.bgBrush = bg;
//             this.textBrush = text;
...
//         // Only builds settings (Row 2 visual block), keeping entirely decoupled from global shells
//         private void BuildSettingsUI()
//         {
//             this.Margin = new Thickness(0, 5, 0, 10);
...
//             this.Children.Add(qualityStack);
//         }

//         // Implementation of the concrete engine execution task
...
//             // Execute engine parameters cleanly
